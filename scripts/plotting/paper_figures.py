...
COLUMN_ALIASES = {
    ...
    "speed": ["speed_marker", "speed_rpm", "omega_m_rpm", "omega_rpm", "omega_m_phys", "omega_m", "omega"],
    "load": ["load_marker", "load_torque_nm", "load_nm", "load_torque", "T_L", "torque"],
    "rmse": ["rmse_all", "rmse", "rmse_iq"],
    "control_energy": ["control_energy", "u_energy", "voltage_energy"],
    "action_smoothness": ["action_delta_energy", "action_smoothness", "delta_action_energy", "action_rate_penalty"],
